...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { file: @content.file, id: @content.id, public: @content.public } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { file: @content.file, id: @content.id, public: @content.public } }
